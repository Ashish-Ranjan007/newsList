...
const Signup = () => {
	return (
		<main className="w-full h-full flex flex-row bg-white">
			...
			></div>
			<div className="w-full h-full px-8 flex flex-col justify-around sm:px-4 sm:my-4 md:px-8 font-body">
				<h1 className="font-medium text-2xl tracking-wide mb-4 mt-8 md:mb-4 md:mt-0">
					Register
				</h1>
				<h6 className="font-normal mb-6 md:mb-2 text-base">
					Signup for a new account
				</h6>
				<aside className="text-gray-400 mb-6 md:mb-2 md:w-96 text-xs">
