...
const Login = () => {
	return (
		<main className="w-full h-full flex flex-row bg-white">
			...
			></div>
			<div className="w-full h-full px-8 sm:px-4 md:px-8 md:flex md:flex-col md:justify-around font-body">
				<figure className="w-32 mt-4 mb-14 md:mb-8">
					<img src={logo} alt="logo" />
				</figure>

				<h1 className="font-medium text-4xl tracking-wide mb-8 md:mb-4">
					Login
				</h1>
				<h6 className="font-normal mb-6 md:mb-2">
					Login to your account
				</h6>
				<aside className="text-gray-400 mb-6 md:mb-2 md:w-96">
